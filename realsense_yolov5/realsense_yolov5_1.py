...
# **내장 colorizer 객체 생성**
colorizer = rs.colorizer()  # realsense-viewer와 동일한 색상 맵 사용
...
try:
    while True:
        ...
        # realsense-viewer와 동일한 방식으로 depth 컬러라이즈 수행
        ...
        for *box, conf, cls in detections:
            if int(cls) == PERSON_CLASS_ID:
                ...
                # 수평 각도 계산: 이미지 중앙(픽셀 img_width/2) 대비 오프셋에 수평 FOV 적용
        ...
        # -------------------------------------
        # 4. 결과 영상 출력 (색상 영상과 내장 colorizer 적용 Depth 영상)
        # -------------------------------------
